...
- **FR-002**: The specification MUST define MVP scope as STEP ingestion, decomposition into manufacturable panels, joint synthesis, unfolding, nesting, and production export.
